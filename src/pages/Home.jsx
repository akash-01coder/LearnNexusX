...
import CodeBlocks from "../components/cores/HomePage/CodeBlock"
...
const Home = () => {
    return (
      ...
      text-white justify-between'>
                ...
                <Link to={"/signup"}>
                    <div className=' group mt-20 p-1 mx-auto rounded-full bg-richblack-800 font-semibold text-richblack-200
            transition-all duration-200 hover:scale-95 w-fit'>
                ...
                <div className=' mt-5 w-[80%] text-center text-base font-medium text-richblack-300'>
                ...
                <div className='mx-16 my-24 shadow-blue-200'>
                    ...
                    <div className='flex flex-row gap-5 mb-10 mt-[95px]'>
                        ...
                        <div className='flex flex-col gap-10 w-[50%] items-start'>
                            <div className='text-[16px]'>
                                The modern LearnNexusX is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
                            </div>
                            <CTAButton active={true} linkto={"/signup"}>
                                <div>
                                    Learn more
